  ...
  return (
    <div className="absolute top-0 bottom-0 right-0 left-0 flex h-screen w-screen justify-center bg-[#000000cc] align-middle">
      <div className="relative m-auto h-1/2 max-h-56 w-4/5 max-w-lg rounded-lg bg-white py-8 text-center">
        ...
        <button className={`transition-colors p-4 rounded-lg ${wrongAnswerds.length === 0? "bg-gray-300 text-gray-600 cursor-not-allowed":"bg-yellow-300 hover:bg-yellow-500"}`} disabled={wrongAnswerds.length === 0} onClick={downloadTxtFile}>
